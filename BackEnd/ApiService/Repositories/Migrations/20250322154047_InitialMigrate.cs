    ...
    public partial class InitialMigrate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Akıllı Telefon kategorisi ", "Akıllı Telefon ", new DateTime(2025, 3, 22, 18, 40, 47, 316, DateTimeKind.Local).AddTicks(2373), null, "Seed Data", true, new DateTime(2025, 3, 22, 18, 40, 47, 317, DateTimeKind.Local).AddTicks(776), null, "Seed Data" },
                    { 2, "Laptop ve Masaüstü Bilgisayarlar", "Bilgisayar", new DateTime(2025, 3, 22, 18, 40, 47, 317, DateTimeKind.Local).AddTicks(1855), null, "Seed Data", true, new DateTime(2025, 3, 22, 18, 40, 47, 317, DateTimeKind.Local).AddTicks(1857), null, "Seed Data" },
                    { 3, "Harici bilgisayar parçaları ", "Bilgisayar bileşenleri ", new DateTime(2025, 3, 22, 18, 40, 47, 317, DateTimeKind.Local).AddTicks(1859), null, "Seed Data", true, new DateTime(2025, 3, 22, 18, 40, 47, 317, DateTimeKind.Local).AddTicks(1860), null, "Seed Data" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2025, 3, 22, 18, 40, 47, 317, DateTimeKind.Local).AddTicks(8570), null, "Seed Data", true, new DateTime(2025, 3, 22, 18, 40, 47, 317, DateTimeKind.Local).AddTicks(8573), null, "Seed Data", "https://cdn.vatanbilgisayar.com/Upload/PRODUCT/apple/thumb/0003-mpuf3tu-a_large.jpg", "128 gb lık versiyon", "Iphone 14", 20000m, 0 },
                    { 2, 1, new DateTime(2025, 3, 22, 18, 40, 47, 317, DateTimeKind.Local).AddTicks(9398), null, "Seed Data", true, new DateTime(2025, 3, 22, 18, 40, 47, 317, DateTimeKind.Local).AddTicks(9400), null, "Seed Data", "https://encrypted-tbn2.gstatic.com/shopping?q=tbn:ANd9GcTNtyK9OXNPvPrrO8AO3JpPGtv9lOTvDRfKku6m3ZqtaO0KRwPUAYmJjgQYoRJLY5HfSoBx4dCkd9O57yAbVdNxGrxgUKmT", "128 gb lık versiyon", "Samsung S24 FE", 15000m, 0 },
                    { 3, 2, new DateTime(2025, 3, 22, 18, 40, 47, 317, DateTimeKind.Local).AddTicks(9402), null, "Seed Data", true, new DateTime(2025, 3, 22, 18, 40, 47, 317, DateTimeKind.Local).AddTicks(9403), null, "Seed Data", "https://m.media-amazon.com/images/I/61tOfogRfXL.__AC_SX300_SY300_QL70_ML2_.jpg", "Yazilimci Bilgisayarı", "Monster Laptop", 40000m, 0 },
                    { 4, 3, new DateTime(2025, 3, 22, 18, 40, 47, 317, DateTimeKind.Local).AddTicks(9405), null, "Seed Data", true, new DateTime(2025, 3, 22, 18, 40, 47, 317, DateTimeKind.Local).AddTicks(9405), null, "Seed Data", "https://encrypted-tbn0.gstatic.com/shopping?q=tbn:ANd9GcSXIJhS_a--H2uKCFDS5BEYT41Vhmf717hT06Z9ySrFl4R_7p6tWkfUwXvyb-zQJJz9JDlOgVE5lxZa0Hr0u3eN4_YOfJk9n6S1V9JAuKqJIFPhpaYTP42Vfw", "500 Gb", "ssd ", 1000m, 0 }
                });
